...
public class VPNTileService extends TileService {
    ...
    public void connectVPN(){
        ...
        showToast(getString(R.string.connecting_to_fastest_server));
        ...
        UnifiedSdk.getInstance().getVpn().start(new SessionConfig.Builder()
            ...
            public void complete() {
                showToast(getString(R.string.connected_to_fastest_server));
                updateTileState(true);
            }
    ...
    public void disconnectVPN(){
        UnifiedSdk.getInstance().getVpn().stop(TrackingConstants.GprReasons.M_UI, new CompletableCallback() {
            @Override
            public void complete() {
                showToast(getString(R.string.vpn_disconnected));
                updateTileState(false);
            }

            @Override
            public void error(@NonNull VpnException e) {
                showToast(getString(R.string.error_disconnecting_vpn));
            }
        });
    }
